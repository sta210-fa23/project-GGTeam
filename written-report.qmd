...
Although there's still slight signs of fanning going on, it's a lot less severe than before. For now, this concludes our EDA/data cleaning process and we move onto our model selection process.
...
model_with_interaction2 <- linear_reg() |>
  set_engine("lm") |>
  fit(followers ~ likes + shares + comments + total_videos + video_length_bin2 + shares * video_length_bin2 + total_videos * video_length_bin2 + total_videos, data = train_transformed)
