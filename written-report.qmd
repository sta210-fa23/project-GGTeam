...
We saw from our initial tidy table that the p-values associated with video length bins are high, indicating that the variables aren't significant. Because of this, we can once again perform cross validation to test how a model without video_length compares to our current model (Model 1):
