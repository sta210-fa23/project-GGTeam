...
We use the transformed dataset to split our data into testing and training.
...
We can see that when we remove video_length, AIC and BIC both significantly decrease and adjusted r-squared increases. However, RMSE also increases. This means that a model without video_length may fit our data better, however it also performs worse when it comes to prediction (there is more distance and error between predicted and observed values). Because of this, we should keep video_length in our model.
