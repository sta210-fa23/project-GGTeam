...
```{r}
ggplot(tiktok, aes(x = video_length, y = n_plays / 100000)) +
  geom_point() + 
  labs(title = "Relationship between Number of Plays and Video Length", x = "Video Length", y = "Number of Plays (in 100000)")
...
ggplot(data = filtered_tiktok, aes(x = user_name, y = n_plays / 100000)) +
  geom_boxplot() +
  coord_flip() +  
  labs(x = "Tiktok Username", y = "Video Views (in 100000)", title = "Video Views Distribution for Top 20 Users (in terms of videos posted)") +
  theme_minimal()
```
